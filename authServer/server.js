...
app.post('/auth/login', (req, res) => {
    ...
    if (user.password == req.body.password) {
        ...
        res.cookie('authcookie', accesstoken, {maxAge: fiveMins, httpOnly: false, secure: true, sameSite: "lax"})
        res.cookie('refreshcookie', refreshToken, {maxAge: oneWeek, httpOnly: true, secure: true, sameSite: "lax" })
        res.send()
    } else {
